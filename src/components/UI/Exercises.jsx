    ...
    <section id='schedule'>
        <div className="container exercise__container">
            <div className="exercise__top">
                ...
                <p>
                    Alias consequatur dolorum iste consequuntur, unde neque numquam doloribus quo ullam reprehenderit ab. <br />
                    Exercitationem atque dolorum deserunt, maiores totam?
                </p>
            </div>
